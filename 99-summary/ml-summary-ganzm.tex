...
If distribution $P(y|x)$ is known, best action $a^*$ is determined: $a^* = arg \min \limits_{a \in \mathcal{A}} E_y[C(y,a)|x]$ where $C(y,a)$ is a cost function. TODO Slide 8
...
Latent Variable: $\gamma_j(x) = P(z=j|x,\Sigma, \mu) = {{w_j P(x|\Sigma_j, \mu_j)}\over{\sum_j w_j P(x|\Sigma_l , \mu_l)}}$ 
