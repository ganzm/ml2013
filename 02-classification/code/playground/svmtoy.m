function svmtoy(label_matrix, instance_matrix, mdl, titleString)
...
plot(instance_matrix(pos, 1), instance_matrix(pos, 2), 'go');
plot(instance_matrix(neg, 1), instance_matrix(neg, 2), 'rx');
